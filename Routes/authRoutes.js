...
const {signUp,login,googleSignIn,changePass,deleteAccount,changeEmail,forgotPassword,resetPassword,faceRegister,faceRemove,faceLogin,logout} = require('../controllers/authControllers')
