...
router.get("/meals/recent", fitness.recentMeals);
...
router.delete("/weight/:id", fitness.deleteWeight);
router.get("/daily", fitness.getDaily);
router.put("/daily", fitness.updateDaily);
router.get("/workouts", fitness.listWorkouts);
router.post("/workouts", fitness.createWorkout);
router.put("/workouts/:id", fitness.updateWorkout);
router.delete("/workouts/:id", fitness.deleteWorkout);
