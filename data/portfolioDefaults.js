/** Default portfolio content seeded on first GET if DB is empty */
module.exports = {
  profile: {
    name: 'Md Ikram',
  ...
  skills: {
    ...
    groups: [
      {
        title: 'Front-end',
        items: ['HTML5', 'CSS3', 'Bootstrap', 'Tailwind', 'MUI', 'jQuery', 'React.js', 'React Native', 'Sass'],
      },
      {
        title: 'Back-end',
        items: ['PHP', 'Node.js', 'Express.js', 'Firebase', 'Prisma', 'Mongoose'],
      },
      {
        title: 'Database',
        items: ['MySQL', 'MongoDB', 'SQLite', 'MariaDB', 'PostgreSQL'],
      },
      {
        title: 'Tools & Software',
        items: ['Docker', 'Postman', 'VS Code', 'Cursor', 'Photoshop', 'Android Studio'],
      },
    ],
  },
  projects: {
    ...
    items: [
      {
        ...
        description:
          'Realtime chat with typing indicators, optimistic updates, and smooth micro-interactions.',
        tags: ['React', 'Socket.io', 'UX'],
      },
      {
        title: 'Performance-led Feed',
        description:
          'Virtualized lists, image optimization, and skeleton states for snappy interactions.',
  ...
  homeExperience: {
    ...
    subtitle: 'Roles that shaped how I build and ship.',
  },
  homeContact: {
    title: 'Contact',
